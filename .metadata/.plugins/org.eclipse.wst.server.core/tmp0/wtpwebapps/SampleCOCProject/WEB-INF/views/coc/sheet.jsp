...
<form method="POST">
  <div id="container">
		<div id="header">
			<a href="../index/index.html">COC 캐릭터 시트</a>
      <a href="../team/team.html">팀구성</a>
			<a href="../sheetPage/sheet.html">시트작성</a>
      <a href="../guide/Guide.html">가이드</a>
      <a href="../updatelog/updateLog.html">업데이트</a>
      <div class="blank"></div>
      <a href="../index/index.html" class="login"> 로그인</a>
		</div>
          ...
          <table id="info">
            ...
            <tr>
              <td colspan="2">
                ...
                <input type="text" name="charaterJob" id="charaterJob">
              </td>
            </tr>
            <tr>
              <td>
